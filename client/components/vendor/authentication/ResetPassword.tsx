...
import { useResetVendorPasswordMutation } from "@/lib/services/vendor/auth.api";
...
const ResetPassword = () => {
  ...
  const [resetPassword, { isLoading }] = useResetVendorPasswordMutation();
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      return router.push(`/vendor/auth`);
    } catch (err: any) {
      addToast({
        title: "Error occured",
